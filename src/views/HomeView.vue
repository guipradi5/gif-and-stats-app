  ...
  <main>  
    <aside class="side-bar">
      ...
      <ul v-else class="side-bar__gif-list">
        <GifListElement v-for="element in gifs" :key="element.id" :element="element" @select="selectGif" />
      </ul>
    </aside>
...
main {
  ...
  .side-bar{
    height: calc(100vh - $topBarHeight - ($topBarVerticalPadding * 2) - $topBarBottomMargin - 30px);
    width: 30%;
