import { getGifs, getCouponsData, getGifClickCount, postGifClick } from "@/api/api";
...
describe("api", () => {
    ...
    test('getCouponsData', async () => {
        ...
        expect(result).toStrictEqual({...axio.data, "dollarOffData": 'typeDate', "percentOffData": 'typeDate', "retailers": 'retailers', "typeCount": {"buyOneGetOne": 'quantity', "dollarOff": 'quantity', "freeGift": 'quantity', "freeShipping": 'quantity', "percentOff": 'quantity'}});
    });
